  ...
  const LetterGlitch = ({
    ...
    return (
      <div className="relative w-full h-full bg-black overflow-hidden">
        ...
        {centerVignette && (
          <div
            className="absolute top-0 left-0 w-full h-full pointer-events-none bg-[radial-gradient(circle,_rgba(0,0,0,0.8)_0%,_rgba(0,0,0,0)_100%)]"
          ></div>
        )}

        <div className="absolute top-0 left-0 w-full h-full bg-black opacity-85 pointer-events-none" />
      </div>
    );
  };
